...
* the child’s capacity to manage transitions;
* the effect of changes to routine;
* sensory needs in each household;
* school attendance and learning support;
* medication and medical care;
* occupational therapy, psychology, speech pathology or other supports;
* sleep, diet and regulation;
* communication needs;
* the child’s relationship with parents, siblings and other important people; and;
...
* How does this child manage change?
* How much recovery time does the child need after a transition?
* Can both homes meet the child’s practical and sensory needs?
* Can the parents communicate reliably about medication, therapy, school and regulation?
* Does the proposed arrangement support the child’s important relationships?
* Is the schedule sustainable during school terms as well as holidays?
...
* visual calendars or written plans;
* familiar belongings in both homes;
* consistent access to communication supports;
* a low-conflict changeover arrangement;
* avoiding unnecessary packing;
* allowing recovery time after changeover; and
...
* medication;
* medical and therapeutic recommendations;
* school attendance;
* safety plans;
* dietary requirements;
* communication aids;
* sleep needs; and
* strategies for responding to distress or dysregulation.
...
* exchange of therapeutic and medical information;
* attendance at appointments;
* communication with schools and providers;
* responsibility for NDIS-related decisions;
* transport;
* transition plans;
* important belongings;
* how urgent decisions will be made; and
* a process for reviewing arrangements as the child develops.
